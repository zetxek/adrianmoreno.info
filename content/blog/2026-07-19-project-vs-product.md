...
If you're preparing for a hiring conversation, here's how I probe for product thinking:

**"Tell me about something you shipped that didn't work."**

Good answers include data, reflection, and what they changed. Bad answers blame the user, blame the timeline, or claim everything worked perfectly.

**"What's something you decided *not* to build?"**

Good answers show prioritisation with a thesis. Bad answers include "we ran out of time" without reflecting on whether the right things got cut.
...
An abstract illustration of an iceberg in dark ocean. Above the waterline, a tidy checklist on a clipboard: "Scope ✅, Budget ✅, Timeline ✅." Below the surface, massive and mostly hidden — large, irregular shapes labelled: "Who uses this? Does it work? Are we solving the right problem?" Dark teal-to-deep-blue gradient. A tiny diver swimming down towards the submerged part.
